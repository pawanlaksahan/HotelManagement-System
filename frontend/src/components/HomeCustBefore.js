            ...
            <div className = "jumbotron">
                <div className = "jumbotron" style={{paddingLeft:'50px', paddingRight:'50px', paddingTop: '10px', backgroundImage: `url(${image})`,backgroundRepeat:'no-repeat', backgroundSize:'cover'}}>
                    ...
                    <div className="jumbotron" style={{backgroundColor:'rgba(255,255,255,0.7)', marginTop:'300px', marginBottom:'100px'}}>
                        <br/>
                        <h1 style={{textAlign: 'center', fontFamily: 'Bonheur Royale', fontSize:'150px', color: 'black', fontWeight: '500'}}>Welcome to Hotel Paradise</h1>
                    </div>
                        <br/><br/><br/><br/>
                        <br/><br/><br/><br/>
                        <br/><br/><br/><br/>
                ...
                <div className="jumbotron" style={{backgroundColor:'rgba(255,255,255,0.8)', padding:'80px 10px 80px 10px'}}>
                    <div className="container">
                        ...
                        <div style={{textAlign: 'center'}}>
                            <h1 style={{fontFamily: 'Bonheur Royale', fontSize:'100px', fontWeight:'600'}}>Hotel Paradise</h1>
                            <h2>SRI LANKA</h2>
                            <p style={{fontSize: '20px'}}>
                                Revel in our histories. Chase our mysteries. Discover extraordinary places. Unwind in our spaces. <br/>
                                At Hotel Paradise, we promise you are in good hands. <br/>
